...
[`vignette("multi-scale-assessment", package = "waywiser")`](https://docs.ropensci.org/waywiser/articles/multi-scale-assessment.md).
...
More information about multi-scale assessment is included in
[`vignette("residual-autocorrelation", package = "waywiser")`](https://docs.ropensci.org/waywiser/articles/residual-autocorrelation.md).
