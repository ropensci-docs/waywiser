# Contributing to waywiser

This outlines how to propose a change to waywiser. For more detailed
...
This package is in an initially stable state of development, with a
great deal of active subsequent development envisioned.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("mikemahoney218/waywiser", fork = TRUE)`.
...
Please note that the waywiser project is released with a [Contributor
